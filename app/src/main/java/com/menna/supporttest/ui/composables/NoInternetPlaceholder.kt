...
fun NoInternetPlaceholder(
    ...
    Column(
        ...
        Text(text = text, style = Typography.titleMedium, color = Black60, modifier = Modifier.padding(vertical = 16.dp))
        Button(onClick = onClickTryAgain) {
            Text(text = "Try again", style = Typography.bodyMedium, color = Black60)
        }
    }
}